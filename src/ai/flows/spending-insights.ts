  ...
  revenues: z
    .array(
      z.object({
        ...
        amount: z
          .number()
          .describe("The amount received from the revenue source."),
      }),
    )
...
export type SpendingInsightsOutput = z.infer<
  ...
  input: {
    schema: z.object({
      ...
      revenues: z
        ...
        .describe(
          "A list of revenue sources with their categories and amounts.",
        ),
      budgetGoals: z
        .array(
          z.object({
            ...
            amount: z
              .number()
              .describe("The target amount for the budget goal."),
          }),
        )
        .describe("A list of budget goals with their categories and amounts."),
    }),
